...
public class withdraw extends JFrame {
	...
	public withdraw() {
		...
		JLabel lblNewLabel = new JLabel("\uCD9C\uAE08\uD560 \uAE08\uC561 ,\uACC4\uC88C\uBC88\uD638\uC640 \uBE44\uBC00\uBC88\uD638\uB97C \uC785\uB825\uD574\uC8FC\uC138\uC694.");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try{
						...
						if(rs.next()){
							int values = Integer.parseInt(withdraw.getText());
							String sql2= "update bank_account SET price = price  - '" +values+"'WHERE Account ='" +Accountall+"'";
							
							stmt.executeUpdate(sql2);
							
							JOptionPane.showMessageDialog(null, withdraw.getText() + "원 출금 되었습니다.");
							dispose();
		...
		JLabel label_3 = new JLabel("\uCD9C\uAE08\uD560 \uAE08\uC561 : ");
		...
		withdraw.setBounds(146, 169, 116, 21);
